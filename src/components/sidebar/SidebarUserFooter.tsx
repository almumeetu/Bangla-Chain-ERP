  ...
  return (
    <div className="p-4 border-t border-slate-900 bg-slate-950/60">
      {!collapsed
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-[10px] text-slate-400 font-mono flex items-center gap-1">
                <span className="w-1.5 h-1.5 bg-slate-400 rounded-none inline-block animate-pulse" />
        ...
        : (
          <div className="w-9 h-9 rounded-none bg-slate-900 flex items-center justify-center font-medium text-white mx-auto cursor-pointer border-0">
            {initial}
          </div>
        )}
    </div>
