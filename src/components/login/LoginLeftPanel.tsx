...
export default function LoginLeftPanel({ language, t }: LoginLeftPanelProps) {
  ...
  return (
    <div className="hidden lg:flex lg:w-[55%] bg-slate-950 relative overflow-hidden flex-col justify-between p-12 select-none">
      ...
      <div className="absolute top-20 right-20 w-72 h-72 bg-white/[0.02] rounded-none blur-3xl" />
      <div className="absolute bottom-32 left-16 w-56 h-56 bg-white/[0.03] rounded-none blur-2xl" />

      {/* Brand */}
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-9 h-9 bg-white rounded-none flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-md">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-none bg-white/[0.06] border border-white/[0.08] mb-5">
        ...
        <div className="space-y-2.5">
          {t.features.map(item => (
            <div key={item.label} className="flex items-center gap-3 px-3 py-2.5 rounded-none bg-white/[0.04] border border-white/[0.06]">
