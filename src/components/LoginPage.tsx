        ...
        <div className="flex justify-end pr-2" onClick={stopPropagation}>
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-none border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-xs font-semibold text-slate-700 transition-all cursor-pointer bg-white"
            >
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="lg:hidden mb-6 sm:mb-8 text-center select-none">
              <div className="flex items-center justify-center gap-2.5 mb-2">
                <div className="w-9 h-9 bg-slate-950 rounded-none flex items-center justify-center">
            ...
            {/* Error banner */}
            {hook.error && (
              <div className="mb-4 px-3 py-2 bg-red-50 border border-red-100 rounded-none">
            ...
            {!hook.isRegistering && (
              <div className="flex mb-5 bg-slate-100 rounded-none p-1 gap-1">
                <button
                  type="button"
                  onClick={onSelectAdminTab}
                  className={`flex-1 min-h-[44px] rounded-none text-[11px] font-bold transition-all cursor-pointer ${hook.loginTab === 'admin' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                >
                  {t.tabAdmin}
                </button>
                <button
                  ...
                  className={`flex-1 min-h-[44px] rounded-none text-[11px] font-bold transition-all cursor-pointer ${hook.loginTab === 'sr' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                >
                  {t.tabSR}
                </button>
              </div>
